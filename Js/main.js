...
import { GameState, formatTime, WARDROBE_ITEMS, getWardrobeItem } from './game.js';
...
function showScreen(screenEl) {
  [mainMenu, wardrobeScreen, checkoutOverlay, resultsScreen].forEach((s) => s.classList.add('hidden'));
...
function startShoppingSession() {
  ...
  player = buildPlayerCharacter(getWardrobeItem(gameState.save.equippedWardrobe));
